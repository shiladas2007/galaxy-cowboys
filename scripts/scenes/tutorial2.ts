    ...
    export class Tutorial2 extends scenes.TutorialScene {
        constructor() {
            let pages: scenes.TutorialPage[] = [
                new TutorialPage("This is Quicksilver John. He has a limited range and fires more slowly, but moves more quickly, and his bullets cut through lasers.", () => {this.page1();}),
                new TutorialPage("This alien is a Watcher - it shoots directly at you, not just straight down!", () => {this.page2();}),
                new TutorialPage("Use John's speed to quickly take it out!", () => {this.page3();}),
            ];
